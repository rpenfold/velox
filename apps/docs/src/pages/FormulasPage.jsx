      ...
      <section style={{ 
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div className="flex gap-4" style={{ justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href={`${basePath}formulas/playground`} className="btn btn-primary" style={{ 
              background: 'white', 
              color: '#4f46e5',
            ...
            <Link href={`${basePath}formulas/docs`} className="btn" style={{ 
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <pre className="p-4 rounded" style={{ 
                ...
                <code>npm install @velox/formulas</code>
              </pre>
            </div>
            <div>
              ...
              <pre className="p-4 rounded" style={{ 
                ...
                <code>{`import XLFormula from '@velox/formulas'
